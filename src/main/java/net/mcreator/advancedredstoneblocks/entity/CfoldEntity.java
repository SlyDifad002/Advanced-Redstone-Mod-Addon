...
import net.mcreator.advancedredstoneblocks.entity.renderer.CfoldRenderer;
...
public class CfoldEntity extends AdvancedredstoneblocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			...
			.size(2f, 2f)).build("cfold").setRegistryName("cfold");
	public CfoldEntity(AdvancedredstoneblocksModElements instance) {
		super(instance, 78);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CfoldRenderer.ModelRegisterHandler());
