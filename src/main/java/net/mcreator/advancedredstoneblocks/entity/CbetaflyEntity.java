...
import net.mcreator.advancedredstoneblocks.entity.renderer.CbetaflyRenderer;
...
public class CbetaflyEntity extends AdvancedredstoneblocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			...
			.size(2f, 2f)).build("cbetafly").setRegistryName("cbetafly");
	public CbetaflyEntity(AdvancedredstoneblocksModElements instance) {
		super(instance, 94);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CbetaflyRenderer.ModelRegisterHandler());
