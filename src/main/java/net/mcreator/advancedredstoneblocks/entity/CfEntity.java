...
import net.mcreator.advancedredstoneblocks.entity.renderer.CfRenderer;
...
public class CfEntity extends AdvancedredstoneblocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			...
			.size(2f, 2f)).build("cf").setRegistryName("cf");
	public CfEntity(AdvancedredstoneblocksModElements instance) {
		super(instance, 75);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CfRenderer.ModelRegisterHandler());
