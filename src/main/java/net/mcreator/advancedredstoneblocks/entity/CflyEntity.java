...
import net.mcreator.advancedredstoneblocks.procedures.CflyPlayerCollidesWithThisEntityProcedure;
import net.mcreator.advancedredstoneblocks.procedures.CflyOnEntityTickUpdateProcedure;
import net.mcreator.advancedredstoneblocks.entity.renderer.CflyRenderer;
...
public class CflyEntity extends AdvancedredstoneblocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(2f, 2f)).build("cfly").setRegistryName("cfly");
	public CflyEntity(AdvancedredstoneblocksModElements instance) {
		super(instance, 80);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CflyRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				CflyOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			double z = this.getPosZ();
			{
				...
				$_dependencies.put("world", world);
				CflyPlayerCollidesWithThisEntityProcedure.executeProcedure($_dependencies);
			}
		}
