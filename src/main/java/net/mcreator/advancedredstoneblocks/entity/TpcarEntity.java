...
import net.mcreator.advancedredstoneblocks.entity.renderer.TpcarRenderer;
...
public class TpcarEntity extends AdvancedredstoneblocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			...
			.size(2f, 2f)).build("tpcar").setRegistryName("tpcar");
	public TpcarEntity(AdvancedredstoneblocksModElements instance) {
		super(instance, 132);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TpcarRenderer.ModelRegisterHandler());
