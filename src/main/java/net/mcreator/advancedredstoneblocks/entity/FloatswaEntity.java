...
import net.mcreator.advancedredstoneblocks.entity.renderer.FloatswaRenderer;
...
public class FloatswaEntity extends AdvancedredstoneblocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			...
			.size(2f, 2f)).build("floatswa").setRegistryName("floatswa");
	public FloatswaEntity(AdvancedredstoneblocksModElements instance) {
		super(instance, 111);
		FMLJavaModLoadingContext.get().getModEventBus().register(new FloatswaRenderer.ModelRegisterHandler());
