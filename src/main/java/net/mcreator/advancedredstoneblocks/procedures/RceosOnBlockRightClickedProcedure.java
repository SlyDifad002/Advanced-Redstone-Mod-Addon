...
public class RceosOnBlockRightClickedProcedure extends AdvancedredstoneblocksModElements.ModElement {
	public RceosOnBlockRightClickedProcedure(AdvancedredstoneblocksModElements instance) {
		super(instance, 56);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				AdvancedredstoneblocksMod.LOGGER.warn("Failed to load dependency x for procedure RceosOnBlockRightClicked!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				AdvancedredstoneblocksMod.LOGGER.warn("Failed to load dependency y for procedure RceosOnBlockRightClicked!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				AdvancedredstoneblocksMod.LOGGER.warn("Failed to load dependency z for procedure RceosOnBlockRightClicked!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				AdvancedredstoneblocksMod.LOGGER.warn("Failed to load dependency world for procedure RceosOnBlockRightClicked!");
			return;
		}
		...
		if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == ReopBlock.block.getDefaultState().getBlock())) {
		...
		} else if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == RceosBlock.block.getDefaultState().getBlock())) {
			if (world instanceof World && !world.isRemote()) {
				((World) world).playSound(null, new BlockPos((int) x, (int) y, (int) z),
