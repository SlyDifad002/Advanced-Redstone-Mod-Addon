...
public class RedoorasRightClickedOnBlockProcedure extends AdvancedredstoneblocksModElements.ModElement {
	public RedoorasRightClickedOnBlockProcedure(AdvancedredstoneblocksModElements instance) {
		super(instance, 59);
	}
