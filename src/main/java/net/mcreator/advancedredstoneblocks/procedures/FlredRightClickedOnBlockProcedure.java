...
public class FlredRightClickedOnBlockProcedure extends AdvancedredstoneblocksModElements.ModElement {
	public FlredRightClickedOnBlockProcedure(AdvancedredstoneblocksModElements instance) {
		super(instance, 113);
	}
