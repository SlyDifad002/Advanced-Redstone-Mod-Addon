...
public class Conversion2Procedure extends AdvancedredstoneblocksModElements.ModElement {
	public Conversion2Procedure(AdvancedredstoneblocksModElements instance) {
		super(instance, 145);
	}
