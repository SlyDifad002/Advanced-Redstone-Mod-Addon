...
public class PandeBlock extends AdvancedredstoneblocksModElements.ModElement {
	@ObjectHolder("advancedredstoneblocks:pande")
	public static final Block block = null;
	public PandeBlock(AdvancedredstoneblocksModElements instance) {
		super(instance, 122);
	}
