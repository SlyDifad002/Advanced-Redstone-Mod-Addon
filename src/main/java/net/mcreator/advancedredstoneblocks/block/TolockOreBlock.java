...
public class TolockOreBlock extends AdvancedredstoneblocksModElements.ModElement {
	@ObjectHolder("advancedredstoneblocks:tolock_ore")
	public static final Block block = null;
	public TolockOreBlock(AdvancedredstoneblocksModElements instance) {
		super(instance, 100);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("advancedredstoneblocks:tolock_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("tolock_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("advancedredstoneblocks:tolock_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
