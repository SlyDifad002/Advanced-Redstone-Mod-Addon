...
public class BetapsBlock extends AdvancedredstoneblocksModElements.ModElement {
	@ObjectHolder("advancedredstoneblocks:betaps")
	public static final Block block = null;
	public BetapsBlock(AdvancedredstoneblocksModElements instance) {
		super(instance, 11);
	}
