...
public class GhdBlock extends AdvancedredstoneblocksModElements.ModElement {
	@ObjectHolder("advancedredstoneblocks:ghd")
	public static final Block block = null;
	public GhdBlock(AdvancedredstoneblocksModElements instance) {
		super(instance, 25);
	}
