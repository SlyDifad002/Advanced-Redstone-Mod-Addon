...
public class GlassBlock extends AdvancedredstoneblocksModElements.ModElement {
	@ObjectHolder("advancedredstoneblocks:glass")
	public static final Block block = null;
	public GlassBlock(AdvancedredstoneblocksModElements instance) {
		super(instance, 121);
	}
