...
public class SlabszxBlock extends AdvancedredstoneblocksModElements.ModElement {
	@ObjectHolder("advancedredstoneblocks:slabszx")
	public static final Block block = null;
	public SlabszxBlock(AdvancedredstoneblocksModElements instance) {
		super(instance, 119);
	}
