...
public class StareBlock extends AdvancedredstoneblocksModElements.ModElement {
	@ObjectHolder("advancedredstoneblocks:stare")
	public static final Block block = null;
	public StareBlock(AdvancedredstoneblocksModElements instance) {
		super(instance, 8);
	}
