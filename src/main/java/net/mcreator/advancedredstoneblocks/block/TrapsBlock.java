...
public class TrapsBlock extends AdvancedredstoneblocksModElements.ModElement {
	@ObjectHolder("advancedredstoneblocks:traps")
	public static final Block block = null;
	public TrapsBlock(AdvancedredstoneblocksModElements instance) {
		super(instance, 10);
	}
