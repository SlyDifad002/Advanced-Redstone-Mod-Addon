...
public class UltimateessItem extends AdvancedredstoneblocksModElements.ModElement {
	@ObjectHolder("advancedredstoneblocks:ultimateess")
	public static final Item block = null;
	public UltimateessItem(AdvancedredstoneblocksModElements instance) {
		super(instance, 21);
	}
