...
public class RcdaItem extends AdvancedredstoneblocksModElements.ModElement {
	@ObjectHolder("advancedredstoneblocks:rcda")
	public static final Item block = null;
	public RcdaItem(AdvancedredstoneblocksModElements instance) {
		super(instance, 88);
	}
