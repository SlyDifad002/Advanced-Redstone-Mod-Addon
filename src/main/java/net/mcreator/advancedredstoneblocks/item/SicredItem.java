...
public class SicredItem extends AdvancedredstoneblocksModElements.ModElement {
	@ObjectHolder("advancedredstoneblocks:sicred")
	public static final Item block = null;
	public SicredItem(AdvancedredstoneblocksModElements instance) {
		super(instance, 15);
	}
