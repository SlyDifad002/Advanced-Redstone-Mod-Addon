...
public class BetessItem extends AdvancedredstoneblocksModElements.ModElement {
	@ObjectHolder("advancedredstoneblocks:betess")
	public static final Item block = null;
	public BetessItem(AdvancedredstoneblocksModElements instance) {
		super(instance, 20);
	}
