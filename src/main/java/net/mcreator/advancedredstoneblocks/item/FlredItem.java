...
import net.mcreator.advancedredstoneblocks.procedures.FlredRightClickedOnBlockProcedure;
...
public class FlredItem extends AdvancedredstoneblocksModElements.ModElement {
	@ObjectHolder("advancedredstoneblocks:flred")
	public static final Item block = null;
	public FlredItem(AdvancedredstoneblocksModElements instance) {
		super(instance, 112);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			ItemStack itemstack = context.getItem();
			{
				...
				FlredRightClickedOnBlockProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
